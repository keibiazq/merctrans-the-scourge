...
const MainBody = () => {
  ...
  return (
    <div className="text-[4.1vw]">
      <div className="bg-[url('/background.svg')] bg-contain md:bg-center px-[4vw] md:px-[20vw] pt-[5vw] text-justify md:text-[1.38vw]">
        <div className="md:content-start gap-[2vw] md:grid md:grid-cols-2">
          <div >
            <DropCap
        ...
        <div className="md:content-start gap-[2vw] md:grid md:grid-cols-2 pb-[2vw]">
          <div className="md:order-last w-fit">
          ...
          <div className="relative left-[-4vw] md:left-0 md:justify-self-end md:pr-5 pb-[3vw] md:pb-0 w-screen md:w-[33vw]">
            <Image
              src="/Untitled-1.png"
              alt="word-games"
              width="410"
