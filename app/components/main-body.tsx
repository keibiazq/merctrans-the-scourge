...
const MainBody = () => {
  ...
  return (
    <div className="bg-[url('/abstract-watercolor-frame.png')] bg-contain md:px-[300px] p-4 pr-5 text-justify md:text-xl">
      <div className="md:content-start md:grid md:grid-cols-2">
        <div className="md:pr-5">
          ...
          — found themselves staring up  at the"
          />
          <p>
            decaying facade of an old Saigon apartment complex, rumored to be haunted by a spirit. But this wasn&apos;t just any ghost hunt. No, Merc and Herc were there on a mission for MercTrans: to exorcize the elusive spirit of &ldquo;
      ...
      <Video />
      <DropCap cap="T" text="HE ghost darted just around the corner, leaving behind a faint hum. Merc sighed, pulling out a" />
      <div className="pb-3">
        <p>
          notebook filled with hastily scribbled translations. &ldquo;Buddhist concepts, ancestor veneration, karma… how do we get that across in English, Herc? It&apos;s one thing for us to understand it, but how can an English-speaking player truly feel it?&rdquo;
        </p>
        <p>
        ...
        <div className="flex flex-row items-center">
          <div className="pr-2 text-8xl">T</div>
          <div>
            HEY turned down another hallway, where the ghost had left eerie scrawlings on the walls.
          </div>
        </div>
        <div className="pb-3">
          <p>
          ...
          <div className="relative left-[-16px] md:left-[-317px] m-0 pb-5 w-screen">
            <Image
              src="/1.png"
              alt="1"
              width="375"
          ...
          <div className="flex flex-row items-center">
            <div className="pr-2 text-8xl">T</div>
            <div>
              HEY continued deeper into the complex, where Herc almost stepped on several abandoned —
            </div>
          </div>
          <div className="pb-3">
            <p>
            ...
            <DropCap cap="T" text="HE ghost led them down a winding staircase, growing louder as if every step brought them closer to " />
            <p>
              her. But then her voice began to shift, her whispers rephrasing and blending as if she couldn&apos;t settle on her words. Merc rolled his eyes.
            </p>
            <p>
            ...
            <DropCap cap="M" text="ERC and Herc moved into the final room. It was eerily silent. Just as Merc began to " />
            <p>
              call out to Herc, he realized he was alone.
            </p>
            <p>
