...
const MainBody = () => {
  ...
  return (
    <div className="bg-[url('/abstract-watercolor-frame.png')] bg-contain md:bg-center md:px-[300px] p-4 pr-5 text-justify md:text-xl">
      ...
      <Divider />
      <TextBlock title="Poetry and its challenges" />

      <div className="md:content-start md:grid md:grid-cols-2">
        <div className="md:pr-5">
          <TextBlock content="THEY turned down another hallway, where the ghost had left eerie scrawlings on the walls. &ldquo;Look,&rdquo; whispered Merc, &ldquo;it&apos;s a poem—a verse that sounds like a warning.&rdquo; The words had a lyrical flow in Vietnamese, deeply tied to the rhythm and wordplay of the language. But how to render it in English?" />
          <p>
      ...
      <Divider />
      <TextBlock title="Playing word games" />

      <div className="md:content-start md:grid md:grid-cols-2">
        <div className="md:order-last">
          <TextBlock content="THEY continued deeper into the complex, where Herc almost stepped on several abandoned —pieces of paper. A single faded word rested in the center of each, the remnants of a Vietnamese word game. &ldquo;Ah, here we go,&rdquo; Herc groaned. &ldquo;How did we get this one into English again?&rdquo;" />
          <p>
      ...
      <div>
        <Divider />
        <TextBlock title="Changing the script" />

        <TextBlock content="THE ghost led them down a winding staircase, growing louder as if every step brought them closer to her. But then her voice began to shift, her whispers rephrasing and blending as if she couldn&apos;t settle on her words. Merc rolled his eyes." />
        <p>
        ...
        <Divider />
        <TextBlock title="The voice in the dark" />

        <TextBlock content="MERC and Herc moved into the final room. It was eerily silent. Just as Merc began to call out to Herc, he realized he was alone. In that moment, Merc understood the haunting weight of The Scourge." />
        <p>
